...
do
    ...
    title=$(get_random_line '/home/juanmr/titulos_csi.txt')
    if [[ -z $title ]] ; 
    then
	title='Request'	
    fi
    ...
    echo   ./jaime.py -l jaime_csi.log -g csi_form -o "ipaddress='$f2'"  -o "username='$user'" -o "emailaddress='support@$f1'"  -o "companyname='$cname'" -o "comments='$f3'"  -o "phonenumber='$phone'" -o "title='$title'" -o "domainname='$f1'" -o "proxy_host=127.0.0.1"  -o "proxy_port=10090"
    

    $JAIMEPATH'jaime.py' -l jaime_csi.log -g csi_form -o "ipaddress='$f2'"  -o "username='$user'" -o "emailaddress='support@$f1'"  -o "companyname='$cname'" -o "comments='$f3'"  -o "phonenumber='$phone'" -o "title='$title'" -o "domainname='$f1'" -o "proxy_host=127.0.0.1"  -o "proxy_port=10090" 
    
    echo  mato el pid $ssh_pid que es el del tunel    
    skill -9 $ssh_pid
     exit  0 ;
done < ./input_data/backoff-CSI.txt
